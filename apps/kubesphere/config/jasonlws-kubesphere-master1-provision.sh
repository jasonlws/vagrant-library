...
echo "[TASK 8] Download Kubekey"
sudo curl -sfL https://get-kk.kubesphere.io | VERSION=v3.0.13 sh -

echo "[TASK 9] Make kk executable"
sudo chmod +x kk

# echo "[TASK 10] "
# sudo ./kk create cluster -f ~/jasonlws-kubesphere-master1/config-sample.yaml -y
